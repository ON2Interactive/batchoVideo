                ...
                <div className="max-w-4xl mx-auto space-y-24">
                    ...
                    <div className="text-center space-y-6">
                        <h1 className="text-[24px] md:text-5xl lg:text-6xl font-bold tracking-tight">
                            About <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">BatchoVideo</span>
                        </h1>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="prose prose-invert max-w-none text-zinc-400 space-y-6">
                            ...
                            <p>
                                BatchoVideo was born from the idea that video editing should be as easy as designing a slide deck. We stripped away the unnecessary complexity and focused on what modern creators actually need: a flexible canvas, intuitive layering, and fast rendering.
                            </p>
                            <p>
                                Today, thousands of creators use BatchoVideo to tell their stories, market their products, and share their knowledge with the world. And we're just getting started.
                            </p>
                        </div>
                    </div>
                </div>
